...
<div class="modal-content">
	...
	<?php if($status==0){ ?>
					<td><a href="user.php?bid=<?=$book_id?>"><button class="btn pill px-4 py-2 btn-danger del_package" data-package_id="<?=$book_id?>" data-status="0"> Pending</button></a></td>
					<?php }
					else if($status==1) { ?>
					<td><a href="user2.php?bid=<?=$book_id?>&name=<?=$name?>&date=<?=$date?>"><button class="btn pill px-4 py-2 btn-warning del_package" data-package_id="<?=$book_id?>" data-status="1">Confirm</button></a></td>
					<?php } else { ?>
			
					<td><button class="btn  pill px-4 py-2 btn-success del_package" data-package_id="<?=$book_id?>" data-status="2"> Booked</button></td>
					<?php } ?>
	</tr>
	<?php
	}
